...
<div class="container">
    ...
    <div class="row">
    	<div class="col-sm-2 col-sm-offset-2 text-right">Book Image</div>
    	<div class="col-sm-4 ">
    		<div class="img-box" onclick="javascript:upImg()">
    			<img alt="" height="100px" src="${bookInfo.upLoadImg.imgSrc}" >
    		</div>
    		<span id="imgSpan">Click image to change</span>
    		<form id="imgForm" action="jsp/admin/BookManageServlet?action=updateImg&id=${bookInfo.bookId}" method="post" enctype="multipart/form-data">
    			...
    			<input type="submit" id="sub" value="Change" class="btn btn-info" style="display:none;margin-left:5px;">
    		</form>
    	</div>
    </div>
     <div class="row">
		<div class="col-sm-2 col-sm-offset-2 text-right">Book Name</div>
		<div class="col-sm-4 ">
		   ${bookInfo.bookName}
		</div>
    ...
    <form id="bookAddForm" class="form-horizontal" action="jsp/admin/BookManageServlet?action=update" method="post">
        ...
        <div class="form-group">
            <label for="catalog" class="col-sm-2 col-sm-offset-2 control-label">Book Category</label>
            <div class="col-sm-4">
        ...
        <div class="form-group">
            <label for="price" class="col-sm-2 col-sm-offset-2 control-label">Price</label>
            <div class="col-sm-4">
        ...
        <div class="form-group">
			<label for="author" class="col-sm-2 col-sm-offset-2 control-label">Book Author</label>
			<div class="col-sm-4 ">
		...
		<div class="form-group">
			<label for="press" class="col-sm-2 col-sm-offset-2 control-label">Book Press</label>
			<div class="col-sm-4 ">
    	...
    	<div class="form-group">
            <label for="desc" class="col-sm-2 col-sm-offset-2 control-label">Description</label>
            <div class="col-sm-4">
                <textarea rows="3" name="desc" id="desc" class="form-control" >${bookInfo.description}</textarea>
            </div>
            <span class="col-sm-4 ckerr">*Optional</span>
        </div>
        <div class="form-group">
