...
<base href="<%=basePath%>">
	...
	<title>Bookstore Admin Management System</title>
...
<body>
	<div class="header container-fluid">
		<a class="title" href="jsp/admin/main.jsp" target="rFrame">Bookstore Admin Management System</a>
		<div class="btn-group adminName">
			<button type="button" class="btn btn-default dropdown-toggle">
			    ${adminUser.userName} <span class="caret"></span>
			</button>
			<ul class="dropdown-menu dropdown-menu-right">
			    <li><a href="LoginOutServlet" target="_top" onClick="return confirm('Are you sure you want to log out?')">Logout</a></li>
			</ul>
		</div>
